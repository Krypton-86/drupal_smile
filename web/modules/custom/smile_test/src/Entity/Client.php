...
use Drupal\smile_test\ClientInterface;
 ...
 *   You can see this in the entity.smile_test_client.canonical
 *   route in the smile_test.routing.yml file. The view can be
 ...
 *
 * @ContentEntityType(
 *   id = "smile_test_client",
 *   label = @Translation("client entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\smile_test\Entity\Controller\ClientListBuilder",
 *     "form" = {
 *       "default" = "Drupal\smile_test\Form\ClientForm",
 *       "delete" = "Drupal\smile_test\Form\ClientDeleteForm",
 *     },
 *     "access" = "Drupal\smile_test\ClientAccessControlHandler",
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/smile_test_client/{smile_test_client}",
 *     "edit-form" = "/smile_test_client/{smile_test_client}/edit",
 *     "delete-form" = "/client/{smile_test_client}/delete",
 *     "collection" = "/smile_test_client/list"
 *   },
 *   field_ui_base_route = "smile_test.client_settings",
 * )
 *
 ...
 *
 * Example: 'entity.smile_test_client.canonical'.
 *
 * See the routing file at smile_test.routing.yml for the
 * corresponding implementation.
 *
 * The Client class defines methods and fields for the Client entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see ClientInterface) also exposes the EntityOwnerInterface.
...
class Client extends ContentEntityBase implements ClientInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['first_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The first name of the Client entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
